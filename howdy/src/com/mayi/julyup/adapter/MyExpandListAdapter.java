...
public class MyExpandListAdapter extends BaseExpandableListAdapter {
	...
	//子标题栏
	public ArrayList<FilesDir_Month> Months=new ArrayList<FilesDir_Month>();
	...
	public void SetMonth(ArrayList<FilesDir_Month> months){
		this.Months=months;
		notifyDataSetChanged();
	}
	
	public ArrayList<FilesDir_Month> GetMonth(){
		return Months;
	}
	...
	public Object getChild(int groupPosition, int childPosition) {
		return  Months.get(groupPosition).getResult().get(childPosition).getCATALOG_NAME();
	}
	//获取子视图的ID
	@Override
	...
	public View getChildView(int groupPosition, int childPosition,boolean isLastChild, View convertView, ViewGroup parent) {
		...
		childhold.childview_count_text.setText(Months.get(groupPosition).getResult().get(childPosition).getFILE_COUNT()+"份文件");
		return convertView;
	}
