...
@EViewGroup(R.layout.upload_finished_list_item)
public class UploadFinishListItem extends LinearLayout {
	@ViewById
	...
	public UploadFinishListItem(Context context) {
		super(context);
		this.context = context;
	}
	
	
	public void Bind(Upload_finish_Been.Data model, int position) {
