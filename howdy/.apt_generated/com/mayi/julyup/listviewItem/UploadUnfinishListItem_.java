...
public final class UploadUnfinishListItem_
    extends UploadUnfinishListItem
    implements HasViews, OnViewChangedListener
{
    ...
    public UploadUnfinishListItem_(Context context) {
        super(context);
        init_();
    }

    public static UploadUnfinishListItem build(Context context) {
        UploadUnfinishListItem_ instance = new UploadUnfinishListItem_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.upload_unfinished_list_item, this);
